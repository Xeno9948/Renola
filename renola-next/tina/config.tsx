        ...
        fields: [
          // ── HERO ──────────────────────────────────────────────
          {
            ...
            fields: [
              ...
              { type: "image", name: "avatar1", label: "Avatar Image 1" },
              { type: "image", name: "avatar2", label: "Avatar Image 2" },
              { type: "image", name: "avatar3", label: "Avatar Image 3" },
              { type: "image", name: "collage_left", label: "Collage Left Image" },
              { type: "image", name: "collage_center", label: "Collage Center Image" },
              { type: "image", name: "collage_right", label: "Collage Right Image" },
            ],
          },
          ...
          // ── ABOUT ─────────────────────────────────────────────
          {
            ...
            fields: [
              ...
              { type: "image", name: "banner_image", label: "Banner Image (Below stats)" },
            ],
          },
          ...
          // ── SERVICES ──────────────────────────────────────────
          {
            ...
            fields: [
              ...
              { type: "image", name: "service1_image", label: "Service 1 Image" },
              ...
              { type: "image", name: "service2_image", label: "Service 2 Image" },
              { type: "string", name: "service3_en", label: "Service 3 (EN)" },
              { type: "string", name: "service3_nl", label: "Service 3 (NL)" },
              { type: "image", name: "service3_image", label: "Service 3 Image" },
            ],
          },
